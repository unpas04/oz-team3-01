...
const QUIZ_DATA_AOT = [
  ...
  { q: "미카사 아커만은 거인의 힘에 대항할 수 있는 '아커만 일족'의 후예다.", a: true, img: "assets/quiz/aot-img/", explanation: "아커만 일족은 인간 상태에서도 거인의 힘 일부를 끌어내어 사용하는 강력한 혈통입니다." },
  { q: "조사병단의 경례 구호는 '심장을 바쳐라!'이다.", a: true, img: "assets/quiz/aot-img/", explanation: "오른쪽 주먹을 왼쪽 가슴 심장 위에 올리는 경례 방식과 함께 사용됩니다." },
  { q: "벽 내부 종교인 '월교'는 벽 안에 거인이 들어있다는 사실을 몰랐다.", a: false, img: "assets/quiz/aot-img/", explanation: "월교의 핵심 인물들은 벽이 거인으로 이루어져 있다는 진실을 이미 알고 있었습니다." },
  { q: "거인이 인간을 잡아먹는 이유는 배가 고파서 영양분을 섭취하기 위함이다.", a: false, img: "assets/quiz/aot-img/", explanation: "거인은 소화 기관이 없으며, 인간을 먹는 행위는 계승자를 찾아 인간으로 돌아가려는 본능입니다." },
  { q: "초대형 거인은 다른 거인들보다 훨씬 크지만 이동 속도는 매우 느리다.", a: true, img: "assets/quiz/aot-img/", explanation: "거대한 크기 때문에 파괴력은 압도적이지만, 동작과 이동 속도는 매우 둔합니다." },
  { q: "턱 거인은 크기가 작지만 날카로운 이빨과 손톱, 빠른 속도가 특징이다.", a: true, img: "assets/quiz/aot-img/", explanation: "강력한 턱 힘으로 경질화된 물체도 부술 수 있는 기동형 거인입니다." },
  { q: "에렌과 친구들이 마침내 벽 밖 세상 끝에서 마주한 것은 '강'이었다.", a: false, img: "assets/quiz/aot-img/", explanation: "모든 거인을 소탕한 후 그들이 도달한 곳은 끝없이 넓은 '바다'였습니다." },
  { q: "시조의 거인의 힘을 완전히 발휘하려면 왕가의 피가 필요하다.", a: true, img: "assets/quiz/aot-img/", explanation: "왕가의 혈통이 아니면 시조의 거인이 가진 '좌표'의 힘을 온전히 쓸 수 없습니다." },
  { q: "리바이 반의 정예 멤버들은 여성형 거인과의 전투에서 전원 생존했다.", a: false, img: "assets/quiz/aot-img/", explanation: "안타깝게도 리바이를 제외한 구 리바이 반 멤버 전원이 여성형 거인에게 전사했습니다." },
  { q: "진격의 거인 애니메이션의 원작 작가는 이사야마 하지메이다.", a: true, img: "assets/quiz/aot-img/", explanation: "이사야마 하지메 작가의 치밀한 복선과 스토리텔링이 돋보이는 작품입니다." }
];
